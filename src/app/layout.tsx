...
export const metadata: Metadata = {
  ...
  description:
    'Магазин та виробництво Укртаб (Запоріжжя, Дніпро). Магнітні наклейки на авто, сувенірні автономери ЗСУ, адресні таблички на будинок, УФ-друк та трафарети. Доставка по Україні 1-2 дні.',
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Укртаб — виробництво магнітних наліпок та табличок в Україні',
      },
    ],
  },
  twitter: {
