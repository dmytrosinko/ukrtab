...
export const metadata: Metadata = {
  title: 'Про компанію Укртаб — Виробництво магнітів на авто, автономерів та табличок у Запоріжжі та Дніпрі',
  description: 'Дізнайтеся більше про виробничу компанію Укртаб (Запоріжжя, Дніпро). Понад 5 років досвіду, власне ЧПУ та УФ-обладнання, якісний магнітний вініл 0.8 мм та надійні матеріали.',
  alternates: {
