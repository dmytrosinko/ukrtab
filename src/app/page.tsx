...
export const metadata: Metadata = {
  ...
  description: 'Виробництво та продаж магнітних наліпок на авто, сувенірних автономерів ЗСУ, адресних табличок на будинок та офісних вивісок від виробника Укртаб (Запоріжжя, Дніпро). Доставка 1-2 дні.',
  keywords:
...
const HOMEPAGE_FAQS = [
  ...
  },
  {
    ...
    answer: 'Доставляємо замовлення щодня по всій Україні швидкою доставкою Новою Поштою (у відділення, поштомат або кур’єром) та Укрпоштою.',
  },
];
