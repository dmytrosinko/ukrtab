          ...
          <div className="pt-2 flex items-center space-x-3">
            ...
            >
              <svg className="w-full h-full" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M28 16C28 22.6274 22.6274 28 16 28C13.4722 28 11.1269 27.2184 9.19266 25.8837L5.09091 26.9091L6.16576 22.8784C4.80092 20.9307 4 18.5589 4 16C4 9.37258 9.37258 4 16 4C22.6274 4 28 9.37258 28 16Z" fill="url(#footer_wa_linear_gradient)"/>
                ...
                <defs>
                  <linearGradient id="footer_wa_linear_gradient" x1="26.5" y1="7" x2="4" y2="28" gradientUnits="userSpaceOnUse">
